                                            ...
                                            <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                                <tr>
                                                    <td style="padding:0 0 36px 0;color:#153643;">
                                                        ...
                                                        <p>Token : ' . $token . '</p>
                                                        <p>Silahkan klik <a href="http://localhost/auth/activation/' . $token . '">disini</a> untuk aktivasi</p>
                                                        <p>Atau klik link di bawah ini</p>  
                                                        <a href="http://localhost/auth/activation">http://localhost/auth/activation/' . $token . '">http://localhost/auth/activation/' . $token . '</a>
