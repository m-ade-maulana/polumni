...
<div class="container-fluid mb-5">
	...
	<div class="card mt-4">
		...
		<div class="card-body">
			<form action="<?= base_url('perusahaan/add_jobs') ?>" method="post">
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<select class="form-control" name="nama_pt">
								<optgroup label="Pilihan PT">
									<?php
									foreach ($data_pt as $dp) { ?>
										<option value="<?= $dp['nama_pt'] ?>"><?= $dp['nama_pt'] ?></option>
									<?php }
									?>
								</optgroup>
						...
						<div class="form-group">
							...
							<select class="form-control name=" name="alamat_pt">
								<optgroup label="Pilihan Lokasi">
									<?php
									foreach ($data_pt as $dl) { ?>
										<option value="<?= $dl['alamat_pt'] ?>"><?= $dl['alamat_pt'] ?></option>
									<?php }
									?>
								</optgroup>
